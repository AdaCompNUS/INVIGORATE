...
def init_kinect():
    ...
    is_cali = 0
    if is_cali:
        robot_coordinate = np.array([0.452503923169, 0.115844369842, -0.132539766277,
                                     0.46016306624, -0.082052757559, -0.12882001526,
                                     0.649967630582, 0.12974363265, -0.128013920542,
                                     0.652354121884, -0.0675214481925, 0.0691775702248])
...
def main():
    ...
    while (True):
        ...
        robot.execute_rec_grasp(kinect1, grasp, transmat)
